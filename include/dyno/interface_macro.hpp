...
#ifndef DYNO_INTERFACE_MACRO_HPP
#define DYNO_INTERFACE_MACRO_HPP

//////////////////////////////////////////////////////////////////////////////
// THIS FILE WAS GENERATED; DO NOT EDIT DIRECTLY.
//
//
// This file is generated from the <dyno/detail/interface_macro.hpp.erb> ERB[1]
// template file. The maximum number of methods that can be handled by the
// macros can be controlled with the 'MAX_NUMBER_OF_METHODS' variable, which
// can be set when calling ERB to generate the header:
//
//    export MAX_NUMBER_OF_METHODS=55
//    erb include/dyno/detail/interface_macro.hpp.erb > include/dyno/interface_macro.hpp
//
...
// - Do not hardcode the requirement on CopyConstructible
// - Allow specifying custom base concepts
...
#endif // DYNO_INTERFACE_MACRO_HPP
